...
namespace NexPayApi.BusinessLogic
{
    ...
    public class PaymentRepository : IPaymentRepository
    {
        ...
        {
            var currentPayments = await GetPaymentsAsync(paymentRequest.AccountNumber);
            ...
            var fileName = $"Payment_{paymentRequest.AccountNumber}";            
